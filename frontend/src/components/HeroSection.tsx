  ...
  return (
    <header className="relative z-10 px-6 py-24 md:pt-48 pt-24 md:mb-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-semibold text-gray-300 leading-tight">
            Create Your Website in Seconds
            <br />
            <div className='flex flex-col'>
            <span className="bg-clip-text text-red-400 font-semibold bg-gradient-to-r from-blue-400 to-red-400 leading-tight">
          ...
          <p className="text-base  font-normal text-gray-400 max-w-2xl mx-auto">
            write your website description and get your website in seconds with
            <span className="text-blue-400 font-semibold"> Boltyy</span>
          </p>
        </motion.div>
